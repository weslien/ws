...
$WS drop t5 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t6 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t9 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t10a t10b 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t11a t11b 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t12 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t13 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t14 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t15 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t16 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
