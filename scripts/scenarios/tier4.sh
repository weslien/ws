...
$WS drop seed61 s61-{1..20} 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t63 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop t64 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop chain65-{0..9} 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop chain66-{0..4} 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop d67-base d67-b d67-c d67-d 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop fo68-seed fo68-{1..10} 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop mk71 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop deep72-fork 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop same73-seed same73-{1..10} 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop diff74-seed diff74-{1..5} 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop dl75-{0..5} 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
rm -rf /tmp/ws-e76-t4
$WS drop el76 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop alt78-{0..2} 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
...
$WS drop cd80a cd80b 2>/dev/null || true; $WS layer gc >/dev/null 2>&1
